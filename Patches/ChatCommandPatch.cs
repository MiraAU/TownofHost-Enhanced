...
#region Role Commands
        ...
        Command.Create("Command.Trial", "{id}", GetString("CommandDescription.Trial"), Command.UsageLevels.RoleSpecific, Command.UsageTimes.InMeeting, JudgeCustom.TrialCommand, false, false, [GetString("CommandArgs.Trial.Id")], [CustomRoles.JudgeCustom, CustomRoles.Councillor]); // ["sp", "jj","tl", "trial", "审判", "判", "审", "審判", "審", "Murder"]
